...
fs.writeFileSync(path.join(__dirname, "integration/render-tests", options.id, "expected-transform.json"), JSON.stringify(map.transform, (key, val) => {return val && val.toFixed ? Number(val.toFixed(20)) : val}, 4), () => {});
        });
    });
